...
class gaji_db(models.Model):
    pegawai = models.ForeignKey(pegawai_db,on_delete=models.PROTECT,blank=True,null=True)
    ...
    t_masakerja  = models.IntegerField(blank=True,null=True)
    t_jabatan  = models.IntegerField(blank=True,null=True)
    t_tetap  = models.IntegerField(blank=True,null=True)
    insentif  = models.IntegerField(blank=True,null=True)
    ...
    rek_sd  = models.ForeignKey(rekening_db,on_delete=models.CASCADE,blank=True)
